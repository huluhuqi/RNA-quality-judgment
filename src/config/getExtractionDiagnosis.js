 ...
 *
 * 保留此文件以维持对旧路径的引用，
 * 新代码请使用：import { getExtractionDatabase } from "@/core/extraction"
 */

import { getExtractionDatabase } from "../core/extraction"
...
export function getExtractionAdvice(method, type){
    ...
    const methodData = getExtractionDatabase(method);
